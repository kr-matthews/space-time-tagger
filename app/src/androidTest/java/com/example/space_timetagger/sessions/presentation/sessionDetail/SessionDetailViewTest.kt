...
class SessionDetailViewTest {
    ...
    @Test
    fun successState_tappingRenameCallsEventTapRename() {
        setup(successState)
        tapRename()
    ...
    @Test
    fun successState_typingNewNameDoesNotCallEventConfirmRename() {
    ...
    @Test
    fun successState_tappingKeyboardDoneCallsEventConfirmRename() {
        setup(successState.editingName())
    ...
    @Test
    fun successState_tappingRenameDialogConfirmCallsEventConfirmRename() {
        setup(successState.editingName())
        val newName = "Croissant"
        typeNewName(newName)
        tapDialogConfirm()
    ...
    @Test
    fun successState_tappingRenameDialogCancelCallsEventCancelRename() {
        setup(successState.editingName())
        val newName = "Croissant"
        typeNewName(newName)
        tapDialogCancel()
    ...
    @Test
    fun successState_tappingOutsideRenameDialogCallsEventCancelRename() {
        setup(successState.editingName())
        val newName = "Spinach"
        typeNewName(newName)
    ...
    @Test
    fun newSuccessState_doesNotHaveIndeterminateProgressIndicator() {
    ...
    @Test
    fun newSuccessState_typingNewNameDoesNotCallEventConfirmRename() {
    ...
    @Test
    fun newSuccessState_tappingKeyboardDoneCallsEventConfirmRename() {
        setup(newSuccessState.editingName())
        val newName = "Eclair"
        typeNewName(newName)
        tapKeyboardDone()
    ...
    @Test
    fun newSuccessState_tappingRenameDialogConfirmCallsEventConfirmRename() {
        setup(newSuccessState.editingName())
        val newName = "Pepper"
        typeNewName(newName)
        tapDialogConfirm()
    ...
    @Test
    fun newSuccessState_tappingRenameDialogCancelCallsEventCancelRename() {
        setup(newSuccessState.editingName())
        val newName = "Croissant"
        typeNewName(newName)
        tapDialogCancel()
    ...
    @Ignore("not clear how to tap outside dialog")
    @Test
    fun newSuccessState_tappingOutsideRenameDialogCallsEventCancelRename() {
        setup(newSuccessState.editingName())
    ...
    @Test
    fun tapAnywhereState_tappingRenameDoesNotCallEventTapAnywhere() {
    ...
    @Ignore("test can't find the tag for some reason")
    @Test
    ...
    fun tapAnywhereState_tappingExistingTagCallsEventTapAnywhere() {
        ...
        verify(mockHandleEvent, times(1)).invoke(any<SessionDetailEvent.TapAnywhere>())
    }
    ...
    @Test
    fun loadingState_hasIndeterminateProgressIndicator() {
        setup(loadingState)
    ...
    @Test
    fun refreshingState_hasIndeterminateProgressIndicator() {
        setup(refreshState)
        getIndeterminateProgressIndicator().assertIsDisplayed()
    }
    ...
    private fun assertAddTagButtonWorks() {
        ...
        verify(mockHandleEvent, times(1)).invoke(any<SessionDetailEvent.TapNewTagButton>())
    }
    ...
    private fun assertAddTagButtonDisabled() {
        ...
        verify(mockHandleEvent, never()).invoke(any<SessionDetailEvent.TapNewTagButton>())
    }
    ...
    private fun verifyTapAnywhereIsNotCalled() {
        verify(mockHandleEvent, never()).invoke(any<SessionDetailEvent.TapAnywhere>())
    }
}
